...
namespace TrackbarFloat
{
	internal static class Helper
	{
		...
		public static Color smethod_2(Color color_0, Color color_1, double double_0)
		{
			...
			double num2 = 1.0 - num;
			int red = (int)((double)(int)color_0.R * num2 + (double)(int)color_1.R * num);
			int green = (int)((double)(int)color_0.G * num2 + (double)(int)color_1.G * num);
			int blue = (int)((double)(int)color_0.B * num2 + (double)(int)color_1.B * num);
			return Color.FromArgb(red, green, blue);
		}

		public static Color smethod_3(Color color_0, Color color_1)
		{
			return smethod_2(color_0, color_1, (int)color_1.A);
		}
	}
}
